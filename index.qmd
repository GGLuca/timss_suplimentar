...
Modelul construit arată în general că variabilele cele mai importante rămân în continuare autoeficacitatea sau cele legate de contextul familial (i.e., statutul socioeconomic). Variabilele de nivel superior (legate de profesor, sau contextul școlar) rămân cu un efect redus sau nesemnificativ.
